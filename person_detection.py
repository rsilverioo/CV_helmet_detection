...
# Image load
image_path = r"test/helmet_3.jpg"
...
# Model configuration
orientations = 8  # Ped = 9
pixels_per_cell = (16, 16)  # Ped = 8
cells_per_block = (2, 1)  # Ped = 3
block_norm = "L2"
feature_vector = True
...
model_path = r"models"
scale = 0
model = joblib.load(os.path.join(model_path, 'person_final.model'))
...
for (x1, y1, x2, y2) in rects:
    ...
    cv2.putText(orig, 'P:'+str(sc[count]), (x1 - 2, y1 - 2), 1, 0.75, (255, 0, 0), 1)
    count += 1
...
for (x1, y1, x2, y2) in pick:
    ...
    cv2.putText(clone, 'Person', (x1 - 2, y1 - 2), 1, 0.75, (0, 255, 0), 1)
